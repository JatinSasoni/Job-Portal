    ...
    <main>
      <section className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 sm:grid-cols-2 p-3 ">
          <div className=" pt-4 md:pt-4 md:px-2 xl:pt-12 xl:px-14 flex flex-col gap-2 xl:gap-4 px-2">
            {/* hero-heading */}
            <motion.h1
              ...
              className=" text-3xl lg:text-5xl leading-8 font-semibold text-gray-700 dark:text-white text-center sm:text-left lg:text-left"
            >
              The{" "}
